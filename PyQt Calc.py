...
class ManinWindow(qtw.QWidget):
    ...
    def keypad(self):
        ...
        # create button
        btn_results = qtw.QPushButton('Enter', clicked = self.func_result)
